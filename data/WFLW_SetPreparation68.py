...
if __name__ == '__main__':
    ...
    Mirror_file = 'WFLW/WFLW_annotations/Mirror68.txt'

    landmarkDirs = ['WFLW/WFLW_annotations/list_68pt_rect_attr_train_test/list_68pt_rect_attr_train.txt',
                    'WFLW/WFLW_annotations/list_68pt_rect_attr_train_test/list_68pt_rect_attr_test.txt']
